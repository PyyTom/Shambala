...
with sl.container(height=500,border=False):
    ...
    with col2:
        ...
        if contacto == 1:webbrowser.open_new_tab('https://www.facebook.com/cruzdelsurshambala/?locale=es_ES')
        elif contacto==0:subprocess.run('pbcopy', text=True, input='+34963552732')
        elif contacto == 3:webbrowser.open_new_tab('https://www.instagram.com/cruzdelsurshambala/?hl=es')
        elif contacto == 2:webbrowser.open_new_tab('https://wa.me/34658828285')
